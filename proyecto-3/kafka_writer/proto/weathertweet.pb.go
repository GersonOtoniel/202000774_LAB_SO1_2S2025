...
const file_proto_weathertweet_proto_rawDesc = "" +
	"\n" +
	"\x18proto/weathertweet.proto\x12\fweathertweet\"\xc7\x01\n" +
...
var (
	...
	file_proto_weathertweet_proto_rawDescData []byte
)

func file_proto_weathertweet_proto_rawDescGZIP() []byte {
	file_proto_weathertweet_proto_rawDescOnce.Do(func() {
		file_proto_weathertweet_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_weathertweet_proto_rawDesc), len(file_proto_weathertweet_proto_rawDesc)))
	})
...
var file_proto_weathertweet_proto_goTypes = []any{
...
func file_proto_weathertweet_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_weathertweet_proto_rawDesc), len(file_proto_weathertweet_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
